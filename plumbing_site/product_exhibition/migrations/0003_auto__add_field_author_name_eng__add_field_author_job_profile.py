...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.name_eng'
        db.add_column(u'product_exhibition_author', 'name_eng',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=15),
                      keep_default=False)

        # Adding field 'Author.job_profile'
        db.add_column(u'product_exhibition_author', 'job_profile',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.name_eng'
        db.delete_column(u'product_exhibition_author', 'name_eng')

        # Deleting field 'Author.job_profile'
        db.delete_column(u'product_exhibition_author', 'job_profile')
