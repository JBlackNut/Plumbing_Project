...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Production.slug'
        db.add_column(u'product_exhibition_production', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='None', unique=True, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Production.slug'
        db.delete_column(u'product_exhibition_production', 'slug')
